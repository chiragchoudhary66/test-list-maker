    ...
    return (function () {
      ...
      function render(self) {
        ...
        var renderLeaf = function (item) {
          ...
          expando.style.transform = item.expanded ? 'rotate(90deg)  scale(1.5)' : 'rotate(0deg)  scale(1.5)';
          ...
          if (item.children && item.children.length > 0) {
            ...
            expando.textContent = '•';
            expando.style['font-size'] = 'smaller';
          }
          return leaf;
        };
      ...
      TreeView.prototype.expand = function (node, leaves, skipEmit) {
        ...
        expando.textContent = '›';
        expando.style.transform = 'rotate(90deg)  scale(1.5)';
      ...
      TreeView.prototype.collapse = function (node, leaves, skipEmit) {
        var expando = node.querySelector('.tree-expando');
        expando.textContent = '›';
        expando.style.transform = 'rotate(0deg) scale(1.5)';
